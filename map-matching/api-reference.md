...
| `begin_route_discontinuity` | The boolean value is true for the begin location of a route disconnect. This value will not exist if this is false. |
| `end_route_discontinuity` |  The boolean value is true for the end location of a route disconnect.  This value will not exist if this is false. |
